    ...
    >
      ...
      >
        ...
        <CarouselContent className="teacher-track">
          ...
          <CarouselItem
            className="teacher-slide"
            aria-label="Ищем преподавателей"
          >
            <Link className="teacher-card teacher-recruitment-card" to="/teacher/join" draggable={false}>
              <span className="teacher-recruitment-mark" aria-hidden="true">+</span>
              <span className="teacher-glass">
                <strong>Ваше фото может быть здесь</strong>
                <span className="teacher-recruitment-copy">Ищем молодых преподавателей</span>
                <span className="teacher-open button button-primary">Стать репетитором</span>
              </span>
            </Link>
          </CarouselItem>
        </CarouselContent>
