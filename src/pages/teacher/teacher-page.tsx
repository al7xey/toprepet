      ...
      <div className="teacher-profile-grid">
        ...
        <div className="teacher-profile-copy">
          ...
          <section
            ...
            aria-labelledby="teacher-achievements"
          >
            <h2 id="teacher-achievements">
            ...
            <div className="teacher-achievements-grid">
              {teacher.achievements.map(
                (achievement) => (
                  <article
                    className="teacher-achievement-card"
          ...
          <section
            className="teacher-profile-section"
            aria-labelledby="teacher-topics"
          >
            <h2 id="teacher-topics">
              С чем поможет
            </h2>
          ...
          <section
            className="teacher-profile-section teacher-profile-approach"
            aria-labelledby="teacher-approach"
          >
            <h2 id="teacher-approach">
          ...
          <div className="teacher-profile-action">
            <div>
              ...
              <span>
                Менеджер уточнит свободное время преподавателя и поможет записаться.
              </span>
            </div>
